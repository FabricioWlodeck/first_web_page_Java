                ...
                <div class="container-fluid">
                    ...
                    <% Entrada entrada = (Entrada) request.getSession().getAttribute("entrada_editar");%>
                               <div class="contact100-form">
                                <form class="form-horizontal" action="editarEntrada_2_Servlet" method ="POST">
                                <fieldset>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-40">
                                  <input id="dni" name="dni" type="text" placeholder="DNI sin puntos" class="form-control input-md">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-40">
                                  <input id="fecha_nac" name="fecha_nac" type="Date" placeholder="Año / Mes / Dia" class="form-control input-md">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-40">
                                  <input id="juego" name="juego" type="text" placeholder="Nombre del Juego" class="form-control input-md">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-40">
                                  <input id="fecha_utilizar" name="fecha_utilizar" type="Date" placeholder=" Año / Mes / Dia " class="form-control input-md">
                                ...
                                <!-- Inserte Hora a Utilizar-->
                                 <div class="form-group">
                                  ...
                                  <div class="col-md-40">
                                  <input id="hora_utilizar" name="hora_utilizar" type="Time" placeholder=" Año / Mes / Dia " class="form-control input-md">
                                  </div>
