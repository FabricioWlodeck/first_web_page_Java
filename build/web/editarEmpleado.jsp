            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <% Empleado empleado = (Empleado) request.getSession().getAttribute("empleado_editar"); %>
                                ...
                                <form class="form-horizontal" action="editarEmpleado_2_Servlet" method ="POST">
                                <fieldset>
                                    
                                <div class="contact100-form">
                                    
                                     <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                        <h1 class="h3 mb-0 text-gray-800"  id="cabecera" >DATOS USUARIO</h1>
                                    </div>
                                    <!----------    --------- Insert USUARIO ---------------------->
                                <!-- Insert DNI -->
                                <div class="form-group">
                                  ...
                                  <div class="col-md-40">
                                  <input id="dni" name="nombre_usuario" type="text" placeholder="<%=empleado.getUser().getNombreUsuario()%>" class="form-control input-md" required="" readonly>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-40">
                                  <input id="nombre" name="contraseña" type="password" placeholder="<%=empleado.getUser().getContraseña()%>" class="form-control input-md" required="" readonly>
                                ...
                                <br>
                                 ...
                                 <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                        <h1 class="h3 mb-0 text-gray-800"  id="cabecera" >EDITAR EMPLEADO</h1>
                                 </div>
                                ...
                                <div class="form-group">
                                  <label class="col-md-4 control-label" for="juego">Cargo</label>  
                                  <div class="col-md-40">
                                  <input  name="cargo" type="text" placeholder="Cargo a Ocupar" class="form-control input-md" required="">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-40">
                                  <input  name="cell" type="text" placeholder="Numero de Celular" class="form-control input-md" required="">
                                ...
                                <!-- Inserte Hora a Utilizar-->
                                 <div class="form-group">
                                  ...
                                  <div class="col-md-40">
                                  <input  name="direccion" type="text" placeholder="Dirección" class="form-control input-md" required="">
                                  </div>
