...
<head>
    ...
    <link href="css/sb-admin-2.min.css" rel="stylesheet" class="theme">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content text-aling-left">
                ...
                <div class="container-fluid">
                    ...
                    <div >
                        ...
                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 60rem;"
                             src="img/imagenIndex.svg" alt="">
                        </div>
                    </div>
