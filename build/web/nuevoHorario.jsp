        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">CARGA HORARIOS</h1>
...
<div class="contact100-form">
                                ...
                                <div class="form-group">
                                  <label class="col-md-4 control-label" for="hora_apertura">Horario de Apertura </label>  
                                  <div class="col-md-40">
                                  <input  name="hora_apertura" type="Time" placeholder="Horario de Apertura de la Atracción" class="form-control input-md" required="">
                                ...
                                <!-- Inserte Apellido -->
                                <div class="form-group">
                                  <label class="col-md-4 control-label" for="hora_cierre">Horario de Cierre</label>  
                                  <div class="col-md-40">
                                  <input  name="hora_cierre" type="Time" placeholder="Horario de Cierre de la Atracción" class="form-control input-md" required="">
