            ...
            <div id="content">
                ...
                <div class="container-fluid">
                   ...
                   <% Juego juego = (Juego) request.getSession().getAttribute("juego_editar"); %>          
                    ...
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"  id="cabecera" >EDITAR JUEGO</h1>
                    </div>

                    <!-- Content Row -->
                            <div class="contact100-form">
                                <form class="form-horizontal" action="editarJuego_2_Servlet" method ="POST">
                                <fieldset>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-40">
                                  <input  name="nombre" type="text" placeholder="<%=juego.getNombre()%>" class="form-control input-md" required="">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-40">
                                  <input id="apellido" name="edad_min" type="number" placeholder="<%=juego.getEdad_min()%>" class="form-control input-md" required="">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-40">
                                  <input id="fecha_nac" name="capacidad_max" type="number" placeholder="<%=juego.getCapacidad_max()%>" class="form-control input-md" required="">
