        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"  id="cabecera" >CARGA JUEGO</h1>
                    </div>

                    <!-- Content Row -->
                            <div class="contact100-form">
                                <form class="form-horizontal" action="altaJuegoServlet" method ="POST">
                                <fieldset>

                                <!-- Insert DNI -->
                                <div class="form-group">
                                  <label class="col-md-4 control-label" for="dni">Nombre </label>  
                                  <div class="col-md-40">
                                  <input  name="nombre" type="text" placeholder="Nombre del Juego" class="form-control input-md" required="">
                                ...
                                <!-- Inserte Apellido -->
                                <div class="form-group">
                                  <label class="col-md-4 control-label" for="edad_min">Edad Minima</label>  
                                  <div class="col-md-40">
                                  <input id="apellido" name="edad_min" type="number" placeholder="Edad Minima para Acceder" class="form-control input-md" required="">
                                ...
                                <div class="form-group">
                                  <label class="col-md-4 control-label" for="capacidad_max">  Capacidad Maxima del Juego   </label>  
                                  <div class="col-md-40">
                                  <input id="fecha_nac" name="capacidad_max" type="number" placeholder="Maximo de Personas por Tanda" class="form-control input-md" required="">
