            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                                ...
                                <form class="form-horizontal" action="altaEmpleadoServlet" method ="POST">
                                <fieldset>
                                    
                                <div class="contact100-form">
                                    
                                     <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                        <h1 class="h3 mb-0 text-gray-800"  id="cabecera" >CARGA USUARIO</h1>
                                    </div>
                                    <!------------------- Insert USUARIO ---------------------->
                                <!-- Insert DNI -->
                                <div class="form-group">
                                  ...
                                  <div class="col-md-40">
                                  <input id="dni" name="nombre_usuario" type="text" placeholder="Nombre de Usuario" class="form-control input-md" required="">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-40">
                                  <input id="nombre" name="contraseña" type="password" placeholder="Contraseña" class="form-control input-md" required="">
                                ...
                                <br>
                                 ...
                                 <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                        <h1 class="h3 mb-0 text-gray-800"  id="cabecera" >CARGA EMPLEADO</h1>
                                 </div>
