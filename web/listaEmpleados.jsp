                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 30rem;"
                             src="img/employees.svg" alt="">
                        <br>
                        <h1 id="cabecera" margin-right="50%" >LISTA DE EMPLEADOS</h1>
                        </div>
                    ...
                    <div class="row">                
                           ...
                           <thead>
                            ...
                            List<Empleado> listaempleado = control.getListaEmpleado();
                            ...
                            %>
                                  ...
                                  <td><%=empleado.getCell()%></td>
                                  <td><%=empleado.getFecha_nac()%></td>
                                  <td><%=empleado.getUser().getId_usuario()%></td>
                                  <td scope="row"> 
                                      <div id="botones">  
                                          <!-- Baja de Entrada -->
                                          <a href="editarEmpleado_1_Servlet?id=<%=empleado.getId_empleado()%>">
                                          ...
                                          <a href="bajaEmpleadoServlet?id=<%=empleado.getId_empleado()%>">
