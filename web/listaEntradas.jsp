            ...
            <div id="content">
                ...
                <div class="text-center">
                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 30rem;"
                             src="img/undraw_printing_invoices_5r4r.svg" alt="">
                        <br>
                        <h1 id="cabecera" margin-right="50%" >ENTRADAS VENDIDAS</h1>
                        </div>
                    ...
                    <div class="row">                               
                           ...
                           <thead>
                                <tr>
                                  ...
                                  <th scope="col">Dia Utilizar</th>
                                  <th scope="col">Hora Utilizar</th>
                            ...
                            List<Entrada> listaentrada = control.getListaEntrada();
                                for (Entrada entrada : listaentrada) { 
                            %>
                                  <td scope="row"><%=entrada.getCodigo_identificacion()%></td>
                                  <td scope="row"><%=entrada.getNombre()%></td>
                                  <td scope="row"><%=entrada.getApellido()%></td>
                                  <td scope="row"><%=entrada.getFecha_utilizar()%></td>
                                  <td scope="row"><%=entrada.getHora_utilizar()%></td>
                                  <td scope="row"><%=entrada.getDni()%></td>
                                  <td scope="row"><%=entrada.getJuego()%></td>
                                  <td scope="row"> 
                                      <div id="botones">
                                          
                                          <!-- Baja de Entrada -->
                                          <a href="editarEntrada_1_Servlet?id=<%=entrada.getCodigo_identificacion()%>">
                                          ...
                                          <a href="bajaEntradaServlet?id=<%=entrada.getCodigo_identificacion()%>">
